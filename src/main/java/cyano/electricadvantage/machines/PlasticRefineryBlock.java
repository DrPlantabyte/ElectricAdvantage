...
///// Overrides to make this a multi-type block /////
	 ...
	 * @param bs The state of the block
	 ...
	 * otherwise
	 */
	public final boolean canAcceptType(IBlockState bs, ConduitType type, EnumFacing blockFace){
	 ...
	 * otherwise
	 */
	public final boolean canAcceptType(ConduitType type, EnumFacing blockFace){
	 ...
	 */
	public final boolean canAcceptType(ConduitType type){
